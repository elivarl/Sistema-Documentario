...
<div class="container">
	...
	<form action='?controller=usuario&action=updateAdmin' method='post'>
		<input type='hidden' name='id' value='<?php echo $usuario->getId(); ?>'>
		<div class="form-group">
		<div class="form-group">
	    	<label for="alias">DNI:</label>
	     	<input type="text" class="form-control" id="dni" name="dni" required="true" readonly="false" value="<?php echo $usuario->getDni(); ?>">
		</div>
	    	<label for="alias">Alias:</label>
	     	<input type="text" class="form-control" id="alias" name="alias" required="true" value="<?php echo $usuario->getAlias(); ?>">
		</div>
